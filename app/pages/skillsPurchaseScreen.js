...
/*
  ...
  load more
*/
export default class SkillsPurchaseScreen extends React.Component {

  static navigationOptions = {
    headerTitle: 'Expert Skills',
  };
  ...
  componentDidMount= async() => {
    this.setState({price: this.props.navigation.state.params.item.Price, itemName: this.props.navigation.state.params.item.skillName,
    ...
    photoURL: this.props.navigation.state.params.item.photo});
