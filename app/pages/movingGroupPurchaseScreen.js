...
/*
  ...
  load more
*/
export default class MovingGroupPurchaseScreen extends React.Component {
  ...
  componentWillMount= async() => {
    this.setState({price: this.props.navigation.state.params.item.Price, sizeStorageUnit: this.props.navigation.state.params.item.sizeStorageUnit,
    ...
    await this.setState({photo: this.props.navigation.state.params.item.photo});
    console.log("item photo state: " + this.state.photo);
    ...
    return (
        <View style={styles.container}>
          <Card style={styles.card}
              ...
              Size Storage Unit: {this.state.sizeStorageUnit} square feet
              </Text>
              <Text style={styles.textStyles}>
