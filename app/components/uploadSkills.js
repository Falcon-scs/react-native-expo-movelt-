...
export default class UploadSkills extends React.Component {
...
storeItem() {
  ...
  firebase.database().ref('skills').child(JSON.stringify(this.state.itemName) + uid).set({
    skillName: this.state.itemName,
    ...
    return (
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        ...
        <View style={styles.feedbackBox}>
          ...
          Post whatever skill you have, and start making money. Ex: (Skill: Will Help You Move, Will Drive You to Airport, etc.)
           </Text>
         </View>
