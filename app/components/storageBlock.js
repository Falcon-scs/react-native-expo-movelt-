...
/*
  ...
  load more
*/
export default class StorageBlock extends React.Component {
  ...
  openStorageScreen() {
    console.log('pressed');
    this.props.rentUnit(this.props.jedi);
  }

  onPressRentUnit = async () => {
...
*/
  render() {
    return (
      <TouchableOpacity onPress={() => this.openStorageScreen()}>
